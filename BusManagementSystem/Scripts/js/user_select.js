...
function click_user(user_id) {
    ...
    if (TO_VAL.indexOf("," + user_id + ",") > 0 || TO_VAL.indexOf(user_id + ",") == 0) {
        ...
        if (parent.frames["dept"] && parent.frames["dept"].document.getElementById("hid_temp_ids")) {
            parent.frames["dept"].document.getElementById("hid_temp_ids").value = to_id.value;
            parent.frames["dept"].document.getElementById("hid_temp_names").value = to_name.value;
        }
